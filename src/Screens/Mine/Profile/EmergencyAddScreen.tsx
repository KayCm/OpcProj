...
export default function EmergencyAddScreen() {
    ...
    return(<View style={{flex:1,backgroundColor:'#F7F7F7'}}>
        ...
        <View style={{paddingHorizontal:appSize(16),marginTop:appSize(12)}}>
                ...
                <View style={{flexDirection:'row',flexWrap:'wrap',alignItems:'center',gap:appSize(8),marginTop:appSize(16)}}>
                    {connectArr.map((value, index, array)=>{
                        return(<TouchableOpacity onPress={()=>{
                            ...
                            <Text style={{color:select==index?'#ffffff':'#333333',fontSize:appSize(14)}}>{value}</Text>
                        </TouchableOpacity>)
                    })}
                </View>
            ...
            <View style={{flexDirection:'row',alignItems:'center',marginTop:appSize(12),height:appSize(50),backgroundColor:'#fff',width:'100%',borderRadius:appSize(8),paddingHorizontal:appSize(16),paddingVertical:appSize(12)}}>

                <Text style={{color:'#333333',fontSize:appSize(14),fontWeight:'800'}}>姓名</Text>
