...
export const MenuBar = () => {
    ...
    return(<View style={{flexDirection:'row',backgroundColor:'#f7f7f7',alignItems:'flex-end',paddingBottom:appSize(10),gap:appSize(16),paddingHorizontal:appSize(16),height:appSize(28)+insets.top,width:'100%'}} >
      <TouchableOpacity onPress={()=>{
