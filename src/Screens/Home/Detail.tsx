...
function Detail(props: any) {
    ...
    var headerHtml = `<div><div style="font-size: 1.75rem;line-height: 2.3rem;font-weight: bold;">${title}</div><div style="font-size: 0.75rem;display: flex;color: #999"><p style="margin-right: 1rem;">${createTime}</p><p style="margin-right: 1rem;">${author}</p></div></div>`
